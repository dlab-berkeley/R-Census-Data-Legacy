...
Because we set `tigris_use_cache = TRUE`, the geographic data are saved locally as an [ESRI Shapefile](https://en.wikipedia.org/wiki/Shapefile), the most common geospatial data file format.  We can use this file for other geospatial mapping and analysis tasks since we have it stored locally. Let's check it out.
